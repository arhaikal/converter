...
ActiveRecord::Schema.define(version: 20170422145324) do
  ...
  create_table "rates", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                 null: false
    t.datetime "updated_at",                                                 null: false
    t.index ["historical_rate_id"], name: "index_rates_on_historical_rate_id", using: :btree
  end
